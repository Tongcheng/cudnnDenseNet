...
if __name__ == '__main__':
    ...
    #BatchNorm then ReLU
    BN1_output, BN_Mean1, BN_Var1 = pyBN_train_Fwd(InitMat,N,InitC,H,W,popMeanVec[:InitC],popVarVec[:InitC],scalerVec[:InitC],biasVec[:InitC],0)
    ...
    BN2_output, BN_Mean2, BN_Var2 = pyBN_train_Fwd(Conv1_output,N,growthRate,H,W,popMeanVec[InitC:InitC+growthRate],popVarVec[InitC:InitC+growthRate],scalerVec[InitC:InitC+growthRate],biasVec[InitC:InitC+growthRate],0)
    ...
    writeTensor1DToFile(BN_Mean1,InitC,'BN_Mean1.txt')
    writeTensor1DToFile(BN_Var1,InitC,'BN_Var1.txt')
    writeTensor1DToFile(BN_Mean2,growthRate,'BN_Mean2.txt')
    writeTensor1DToFile(BN_Var2,growthRate,'BN_Var2.txt')
